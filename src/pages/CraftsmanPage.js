...
function CraftsmanPage(){
    return(<div>
        ...
        <p>Caedmon loves to learn any skill if it involves creating.
            He has learned woodworking, jewling, <a href ="#sewing">sewing</a>, and cooking, but his prefured craft is <a href="#pytography">pyrography</a> (wood burning).
            This love for creating is the primary reason he seeks to become a <Link to="/software">software engineer,</Link> where he can create things that help people around the world.
        </p>
